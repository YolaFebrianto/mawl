							...
							<table class="table table-striped" id="dtTable">
								<thead>
									<tr>
										...
										<th style="text-align:center;"></th>
										<th style="text-align:center;"></th>
										<th style="text-align:right;">Negara2</th>
								...
								<tbody>
									...
									<tr>
										...
										<td width="110px"><?php echo $v->negara1; ?></td>
										<td width="15px" style="text-align:center;"><?php echo $v->skor1; ?></td>
										<td width="5px" style="text-align:center;">-</td>
										<td width="15px" style="text-align:center;"><?php echo $v->skor2; ?></td>
										<td width="110px" style="text-align:right;"><?php echo $v->negara2; ?></td>
										<td style="text-align:center;"><?php echo $v->babak; ?></td>
										<?php $tgl = date('d M Y',strtotime($v->tanggal)); ?>
										<td style="text-align:center;"><?php echo $tgl; ?></td>
										<td style="text-align:center;"><?php echo $v->keterangan; ?></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>

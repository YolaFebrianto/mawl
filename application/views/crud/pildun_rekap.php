							...
							<table class="table table-striped" id="dtTable">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $v->negara; ?></td>
										<td width="50px"><?php echo $v->kode; ?></td>
										<td width="50px"><?php echo $v->grup; ?></td>
										<td width="50px"><?php echo $v->konfederasi; ?></td>
										<td width="20px" style="text-align:center;"><?php echo @$v->POIN; ?></td>
										...
										<td width="25px" style="text-align:center;"><?php echo (@$v->SELISIH>0)?'+'.@$v->SELISIH:@$v->SELISIH; ?></td>
										<td style="text-align:left;"><?php echo @get_last_round($v->kode); ?></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
